...
Route::get('admin/category/edit',[CategoryController::class, 'edit'])->name('u.edit');
...
Route::get('admin/product/productedit',[ProductController::class, 'productedit'])->name('u.productedit');
